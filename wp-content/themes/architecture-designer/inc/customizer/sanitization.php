 ...
 */
function architecturedesigner_sanitize_checkbox( $checked ) {
	// Boolean check.
...
function architecturedesigner_switch_sanitization( $input ) {
    if ( true === $input ) {
        return 1;
    } else {
        return 0;
...
function architecturedesigner_sanitize_choices( $input, $setting ) {
    global $wp_customize; 
...
function architecturedesigner_sanitize_float( $input ) {
 ...
 */
function architecturedesigner_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function architecturedesigner_sanitize_html( $html ) {
 ...
 */
function architecturedesigner_sanitize_image( $image, $setting ) {
 ...
 */
function architecturedesigner_sanitize_nohtml( $nohtml ) {
 ...
 */
function architecturedesigner_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function architecturedesigner_sanitize_range_value( $number, $setting ) {
 ...
 */
function architecturedesigner_sanitize_select( $input, $setting ) {
 ...
 */
function architecturedesigner_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function architecturedesigner_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function architecturedesigner_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
