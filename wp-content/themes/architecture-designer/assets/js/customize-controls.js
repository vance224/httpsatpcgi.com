...
( function( $ ) {
  ...
  api.bind( 'pane-contents-reflowed', function() {
    ...
    api.section.each( function( section ) {
      ...
      if (
        'architecturedesigner_section' !== section.params.type ||
    ...
    api.panel.each( function( panel ) {
      ...
      if (
        'architecturedesigner_panel' !== panel.params.type ||
  ...
  wp.customize.Panel = wp.customize.Panel.extend({
    attachEvents: function() {
      ...
      if (
        'architecturedesigner_panel' !== this.params.type ||
  ...
  wp.customize.Section = wp.customize.Section.extend({
    attachEvents: function() {
      if (
        'architecturedesigner_section' !== this.params.type ||
...
(function (api) {
  ...
  api.Tab = api.Control.extend({
    ready: function () {
      var control = this;
      control.container.find('a.architecturedesigner-customizer-tab').click(function (evt) {
        var tab = jQuery(this).data('tab');
        evt.preventDefault();
        control.container.find('a.architecturedesigner-customizer-tab').removeClass('active');
  ...
  jQuery.extend(api.controlConstructor, {
    'architecturedesigner-tab': api.Tab
  });
...
jQuery( document ).ready(function($) {
  ...
  $('.refresh-btn').on('click', function() {
    ...
    $.get( architecturedesigner_customizer_params.ajaxurl + '?action=' + dataValue, function( data ) {
